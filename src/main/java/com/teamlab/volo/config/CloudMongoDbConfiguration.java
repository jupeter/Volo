...
import com.teamlab.volo.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.teamlab.volo.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.teamlab.volo.config.dbmigrations");
